...
% TODO: ENTREGA 2:
% \subsection{Motivaci\'on social}
% \subsection{Motivaci\'on acad\'emica}


\section{Marco Te\'orico}

% TODO: Debe contener la teoría necesaria para entender el texto del informe

\section{Estado del Arte}

% TODO: ENTREGA 1 -> Cada integrante del grupo debe leer 2 papers en torno al proyecto que proponen

% ENTREGA 2
% TODO: Analizar los artículos/tesis presentados de manera más extensa. Cada trabajo analizado debe responder:
% TODO: i. ¿Qué hicieron los autores?
% TODO: ii. ¿Cómo lo hicieron (aquí deben mencionar componentes y metodologías  utilizadas) ?
% TODO: iii. ¿Cuáles fueron los resultados?
% TODO: iv. ¿Qué consideran uds que podría ser mejorado del trabajo analizado?
% TODO: El estado del arte debe incluir trabajos analizados de los últimos 7 años.


\section{Metodolog\'a}

% ENTREGA 1
% TODO: a. Lista de componentes
...
\subsubsection{Microcontrolador a usar}

El ESP32 se utilizará como el microcontrolador central del proyecto, encargado de procesar la información recibida de los sensores (MPU6050 y MAX30102), realizar los cálculos necesarios (como la inclinación de la espalda y el nivel de oxigenación/pulso), y enviar los datos a un servidor o dispositivo móvil a través de conexión Wi-Fi o Bluetooth.

Alguna de sus características claves son: Conectividad Wi-Fi y Bluetooth incorporada, compatibilidad con Arduino IDE y otros entornos de desarrollo, bajo consumo de energía para aplicaciones portátiles, entre muchos otros.

% TODO: b. Microcontrolador a usar
% TODO: c. Diagrama de bloques del sistema propuesto

% ENTREGA 2
% TODO: a. Deberá contener diagrama de bloques, mapa o representación gráﬁca del planteamiento.
% TODO: b. La metodología deberá incluir como mínimo una ﬁgura y un texto explicativo basado en el estado del arte.
