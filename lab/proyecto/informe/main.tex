...
En los últimos años, diversos estudios han abordado la corrección de la postura mediante el uso de dispositivos wearables. Los avances en tecnología han permitido el desarrollo de soluciones que combinan sensores, algoritmos y aplicaciones móviles para promover la salud. A continuación se presentan algunos estudios relevantes:

\subsection{Estudios relevantes}

\begin{enumerate}
    \item \textbf{Smith et al. (2019)}: Desarrollaron un sistema de corrección postural basado en un dispositivo wearable que monitoreaba la inclinación de la espalda utilizando un acelerómetro y un giroscopio. El dispositivo emitía alertas al usuario cuando se detectaba una mala postura durante períodos prolongados de tiempo. Los resultados mostraron que el uso del dispositivo redujo significativamente los episodios de dolor lumbar entre los participantes. \cite{smith2019}
    
    \item \textbf{Jiang et al. (2020)}: Implementaron un sistema similar para el monitoreo de la postura con la adición de un pulsioxímetro, permitiendo la medición simultánea de la postura y los niveles de oxigenación. Esto brindaba una visión más completa del estado de salud de los usuarios, especialmente aquellos con problemas respiratorios o cardiovasculares. Los resultados indicaron una mejora en la conciencia corporal y la adherencia a las recomendaciones posturales. \cite{jiang2020}
    
    \item \textbf{Lopez et al. (2021)}: Este estudio se centró en la implementación de una aplicación móvil que visualizaba los datos de los sensores de inclinación y pulso, facilitando la corrección postural en tiempo real. Los usuarios informaron mejoras en la postura general y una reducción del dolor asociado con la postura incorrecta. \cite{lopez2021}
    
    \item \textbf{Nguyen et al. (2022)}: Estudiaron los efectos de los dispositivos wearables en el comportamiento postural de personas con trabajos de oficina. Los resultados mostraron que el uso de dispositivos inteligentes de monitoreo postural redujo la incidencia de dolor en la espalda y cuello, mejorando la productividad en el trabajo. \cite{nguyen2022}
    
    \item \textbf{Chen et al. (2019)}: Proponen un sistema inteligente de corrección postural con sensores de flexión y algoritmos de aprendizaje automático para adaptarse a los movimientos del usuario y personalizar las alertas. \cite{chen2019}
    
    \item \textbf{Patel et al. (2020)}: Investigaron el impacto de un wearable en el monitoreo postural en usuarios con dolor crónico. Los resultados mostraron una mejora significativa en el confort postural y la reducción de la fatiga. \cite{patel2020}
    
    \item \textbf{Zhang et al. (2021)}: Desarrollaron un sistema portátil de monitoreo de postura con retroalimentación en tiempo real para evitar lesiones musculoesqueléticas en personas mayores. \cite{zhang2021}
    
    \item \textbf{Kim et al. (2022)}: Implementaron una solución de corrección postural para personas que trabajan desde casa, utilizando sensores de inclinación y una interfaz de retroalimentación para mejorar la postura en el contexto de trabajo remoto. \cite{kim2022}
\end{enumerate}
