...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{./img/riego_estado_riego.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{./img/riego_sobrehidratacion.png}
    \caption{Implementación en laboratorio: Estado de alerta (LED rojo encendido y buzzer activo)}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{./img/riego_monitoreo.png}
